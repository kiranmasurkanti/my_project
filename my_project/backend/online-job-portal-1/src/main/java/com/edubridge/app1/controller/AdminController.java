...
public class AdminController {
	...
	@PostMapping("/admin")
	public ResponseEntity<Admin>save(@RequestBody Admin ad) throws UnsupportedEncodingException, MessagingException{
		Admin saveadmin=service.saveAdmin(ad);
		service.sendVerificationEmail(ad);
